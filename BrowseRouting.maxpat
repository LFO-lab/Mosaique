...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 140.0, 141.0, 22.0 ],
					"text" : "loadmess #1 #2"
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "",
					"id" : "obj-115",
					"items" : [ "Ext. In", ",", "1-___MosaiqueServer_v0.1.2", ",", "3-Bongos_Baguette_Improvisation", ",", "4-Audio", ",", "A-Reverb", ",", "B-Delay", ",", "C-Return", ",", "D-Return", ",", "Main", ",", "No Input" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 370.0, 80.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 14.0, 75.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "",
					"id" : "obj-27",
					"items" : [ "1/2", ",", "1", ",", "2", ",", "No Input" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 410.0, 80.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 29.0, 75.0, 21.0 ]
				}

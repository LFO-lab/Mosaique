...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 588.5, 593.5, 157.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 588.5, 536.5, 386.0, 22.0 ],
					"text" : "mosaique.concataudiofiles @destination #1Mosaique_corpusAudio",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.5, 560.5, 30.0, 30.0 ]
				}

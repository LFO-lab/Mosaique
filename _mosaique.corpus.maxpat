...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "analyze" ],
					"patching_rect" : [ 61.0, 96.0, 183.0, 22.0 ],
					"text" : "_mosaique.importation_v2 #1 #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 73.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 64.364594697952271, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 62.031259000301361, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 64.364594697952271, 75.0, 20.0 ],
					"text" : "Load corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1622.333333333333258, 138.5, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 1622.333333333333258, 109.5, 35.0, 22.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1611.0, 48.031259000301361, 53.0, 49.468740999698639 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 5.5, 37.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.992125984251969, 0.763779527559055, 0.724409448818898, 1.0 ],
					"id" : "obj-4",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 3.5, 37.0, 51.0 ],
					"proportion" : 0.39
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 147.0, 150.0, 47.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 238.0, 62.0, 22.0 ],
									"text" : "append 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 198.5, 61.0, 22.0 ],
									"text" : "zl.group 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 164.5, 97.0, 22.0 ],
...
,
					"patching_rect" : [ 1521.833329677581787, 138.5, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1279.833329677581787, 301.234323263168335, 261.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1521.833329677581787, 109.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 994.0, 153.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1011.0, 186.5, 80.0, 22.0 ],
					"text" : "set #2Corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 748.0, 333.5, 265.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 994.0, 210.5, 93.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 2.5, 93.0, 20.0 ],
					"text" : "Name of corpus"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 61.0, 60.031259000301361, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 62.364594697952271, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1145.666670322418213, 423.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1295.0, 486.0, 150.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.0, 587.0, 150.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.0, 521.234323263168335, 333.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.5, 649.0, 490.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 913.0, 453.031259000301361, 473.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 809.5, 411.364594697952271, 34.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 772.0, 411.364594697952271, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.0, 453.031259000301361, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 214.281306236982346, 183.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 419.265629500150681, 200.0, 22.0 ],
					"text" : "_mosaique.gui.importation #1 #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "analyze" ],
					"patching_rect" : [ 518.0, 246.75, 163.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 459.734323263168335, 169.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-28::obj-11::obj-13" : [ "live.numbox", "live.numbox", 0 ],
			"obj-28::obj-11::obj-16" : [ "live.numbox[3]", "live.numbox", 0 ],
			"obj-28::obj-11::obj-23" : [ "number", "live.numbox", 0 ],
			"obj-28::obj-11::obj-24" : [ "number[1]", "live.numbox", 0 ],
			"obj-28::obj-11::obj-66" : [ "live.menu[5]", "live.menu", 0 ],
			"obj-28::obj-19" : [ "live.text[2]", "live.text[2]", 0 ],
			"obj-28::obj-20" : [ "live.text[3]", "live.text[2]", 0 ],
			"obj-28::obj-21::obj-10" : [ "live.text[1]", "live.text", 0 ],
			"obj-28::obj-21::obj-7" : [ "live.text", "live.text", 0 ],
			"obj-28::obj-3::obj-11" : [ "number[2]", "live.numbox", 0 ],
			"obj-28::obj-3::obj-29" : [ "number[3]", "live.numbox", 0 ],
			"obj-28::obj-3::obj-3" : [ "number[4]", "live.numbox", 0 ],
			"obj-28::obj-3::obj-31" : [ "live.menu[4]", "live.menu", 0 ],
			"obj-36" : [ "live.text[10]", "live.text[10]", 0 ],
			"obj-37" : [ "live.text[11]", "live.text[10]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "_mosaique.importation_v2.maxpat",
				"bootpath" : "~/Documents/GitHub/Corpus",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
